...
! function() {
    ...
    Annotator.Editor = function(_super) {
        ...
        Editor.prototype.html = '<div class="annotator-outer annotator-editor"><form class="annotator-widget"><ul class="annotator-listing"></ul><div class="annotator-controls">    <a href="#cancel" class="annotator-cancel">' + _t("Cancel") + '</a> <a href="#save" class="annotator-save annotator-focus">' + _t("Save") + "</a></div></form>\n</div>";
    ...
    Annotator.Viewer = function(_super) {
        ...
        Viewer.prototype.html = {
            element: '<div class="annotator-outer annotator-viewer"><ul class="annotator-widget annotator-listing"></ul>\n</div>',
            item: '<li class="annotator-annotation annotator-item"><span class="annotator-controls"><a href="#" title="View as webpage" class="annotator-link">View as webpage</a><button title="Edit" class="annotator-edit">Edit</button><button title="Delete" class="annotator-delete">Delete</button></span></li>'
        };
    ...
    Annotator.Plugin.Filter = function(_super) {
        ...
        Filter.prototype.html = {
            element: '<div class="annotator-filter"><strong>' + Annotator._t("Navigate:") + '</strong>\n<span class="annotator-filter-navigation"><button class="annotator-filter-previous">' + Annotator._t("Previous") + '</button>\n<button class="annotator-filter-next">' + Annotator._t("Next") + "</button>\n</span>\n<strong>" + Annotator._t("Filter by:") + "</strong>\n</div>",
            filter: '<span class="annotator-filter-property"><label></label><input/><button class="annotator-filter-clear">' + Annotator._t("Clear") + "</button>\n</span>"
        };
...
//
//# sourceMappingURL=annotator-full.min.maps